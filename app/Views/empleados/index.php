...
<a href="<?= base_url('empleados/new'); ?>" class="btn btn-info btn-sm">Agregar</a> 
...
<table class="table table-hover table-bordered my-3" aria-describedby="titulo">
    <thead class="table-dark">
        <tr>
            ...
            <th scope="col">Delegacion/Municipio</th>
    ...
    <tbody>
        ...
        <?php foreach ($empleados as $empleado) : ?>
            <tr>
                ...
                <td><?= $empleado['delegacion_municipio']; ?></td>
                <td>
